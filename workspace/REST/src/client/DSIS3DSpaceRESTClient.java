...
public class DSIS3DSpaceRESTClient {
    ...
    public void consume() throws Exception {
        ...
        String requestURL = _urlPassport + "/login?action=get_auth_params&service=" +
            URLEncoder.encode(_urlService, ENCODING);
        ...
        String postDataString = "lt=" + loginTicket +
            "&username=" + URLEncoder.encode(_username, ENCODING) +
            "&password=" + URLEncoder.encode(_password.toString(), ENCODING);

        // build the request URL
        requestURL = _urlPassport + "/login?service=" + 
            URLEncoder.encode(_urlService, ENCODING);
