...
public class RestClient {
	...
	public static void main(String[] args) {
		...
		//this is for find objects service
		//String urlService = "https://3dspace.sa.com/3dspace/resources/HondaRestServiceModeler/HondaFindObjects?type=Person";
		
		//this is for Hello service which prints user name
		//String urlService = "https://3dspace.sa.com/3dspace/resources/hello/hello?username=sanne_admin";
		
		//this is for Hello service which prints user name
		//String urlService = "https://3dspace.sa.com/3dspace/resources/part/query?partName=partName&partRevision=partRevision&partVault=partVault";
		String urlService = "https://3dspace.sa.com/3dspace/resources/part/query";
