...
public class DSIS3DSpaceRESTClientMain {
    ...
    private static final String OPT_URL_PASSPORT = "-urlPassport";
    private static final String OPT_URL_SERVICE = "-urlService";
    private static final String OPT_USERNAME = "-username";
    private static final String OPT_PASSWORD = "-password";
    private static final String OPT_SECURITYCONTEXT = "-securityContext";
