...
public class WebServiceTester  {
   ...
   private String REST_SERVICE_URL = "http://localhost:2020/UserManagement2/rest2/UserService/users";
   ...
   private void testUpdateUser(){
      Form form = new Form();
      form.param("id", "1");
      form.param("name", "Julien");
      form.param("profession", "Infra Platform Expert");
   ...
   private void testAddUser(){
      ...
      form.param("profession", "Delmia Solution Architect");
